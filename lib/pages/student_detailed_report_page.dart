    ...
    return Scaffold(
      ...
      body: Consumer<VolunteerProvider>(
        builder: (context, volunteerProvider, child) {
          final relevantReports = volunteerProvider.reports
              .where((report) => report.selectedStudents.contains(student.name))
              .toList();
          
          final lessonsLearned = relevantReports
              .map((report) => report.activityTaught)
              .toSet()
              .toList();
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (lessonsLearned.isEmpty)
                          ...
                          ...lessonsLearned.map((lesson) => ListTile(
